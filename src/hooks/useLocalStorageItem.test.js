...
describe(useLocalStorageItem, () => {
  ...
  it("recovers a string item from local storage after mount if previously stored", async () => {
  ...
  it.skip("recovers an object item from local storage after mount if previously stored", async () => {
    const updatedValue = { banana: true };
